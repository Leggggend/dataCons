...
int main(void) {
    ...
    while (op) {
        ...
        printf("    如果要创建/添加新的线性表，请按16-1-...的操作顺序。\n");
        printf("    请输入您的操作 [0 ~ 21]: ");
        scanf("%d", &op);        
        printf("---------------------------------------------------------\n");
        switch (op) {
        case 1:
            ...
            if (index < 0 || Lists.elem[index].L.elem != NULL) {
                ...
                while (e)
                {
                    Lists.elem[index].L.elem[Lists.elem[index].L.length++] = e;
                    scanf("%d", &e);
                }
                printf("输入成功!\n");
            } else {
        ...
        case 13:
            ...
            if (index < 0) {
                ...
                int x = MaxSubArray(Lists.elem[index].L);
                if ( x <= 0) {
                    printf("操作失败!\n");
                } else {
                    printf("最大连续子数组的和为%d!\n", x);
        ...
        case 14: 
            ...
            if (index < 0) {
                ...
                printf("请输入 k:");
                scanf("%d", &k);
                int x = SubArrayNum(Lists.elem[index].L, k);
                if (x < 1) {
                    printf("操作失败\n");
                } else {
                    printf("存在%d个!\n", x);
        ...
        case 15:
            ...
            if (index < 0) {
                ...
                if (SortList(Lists.elem[index].L) == OK) {
                    printf("排序成功!\n");
                } else {
                    printf("操作失败\n");
                }
